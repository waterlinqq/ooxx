...
export const CLASSES = {
  ...
  raceCar: {
    ...
    lineMove: true,
    type: 'melee',
    desc: '上下左右直線無限移動與攻擊（受障礙物阻擋），攻擊時駛入目標鄰格',
  },
  priest: {
    id: 'priest',
    name: '牧師',
  ...
  slime: {
    ...
    desc: '上下左右近戰；命中使敵人定身一回合（無法移動，仍可攻擊）',
  },
  crabGeneral: {
    id: 'crabGeneral',
    name: '蟹將',
  ...
  thunderGod: {
    ...
    type: 'thunder',
    stunOnHit: true,
    desc: '上下左右移動；可攻擊棋盤上任意敵方，命中使敵人暈眩一回合',
  },
  castle: {
    id: 'castle',
    name: '城堡',
...
export function createUnit(classId, teamId, options = {}) {
  ...
  return {
    ...
    poisonFresh: false,
    immobilized: false,
    immobilizeExpiresOnTurnEnd: false,
    stunned: false,
    stunExpiresOnTurnEnd: false,
    type: cls.type,
    row: -1,
    col: -1,
  };
